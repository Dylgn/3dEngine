...
class BasicGameEngine: public GameEngine {
    public:
        ...
        bool OnStart() override {
            ...
            m_objects.push_back(new Object("../resources/scene01.obj", "../resources/grass.bmp"));
            m_objects.push_back(new Object("../resources/scene02.obj", "../resources/box.bmp"));
            m_objects.push_back(new Object("../resources/scene03.obj", "../resources/redbrick.bmp"));
            m_objects.push_back(new Object("../resources/scene04.obj", "../resources/stone.bmp"));
            m_objects.push_back(new Object("../resources/scene05.obj", "../resources/stone.bmp"));
            m_objects.push_back(new Object("../resources/scene06.obj", "../resources/stone.bmp"));
            m_objects.push_back(new Object("../resources/scene07.obj", "../resources/stone.bmp"));
            m_objects.push_back(new Object("../resources/scene08.obj", "../resources/stone.bmp"));
